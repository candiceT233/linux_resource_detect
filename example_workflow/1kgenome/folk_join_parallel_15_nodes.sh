...
CURRENT_DIR=/qfs/projects/oddite/lenny/hermes_scripts/1kgenome_sbatch_bluesky
...
echo "individuals: $((timestamp2 - timestamp1))"
...
echo "individuals_merge+sifting: $((timestamp3 - timestamp2))"
...
echo "mutation+frequency: $((timestamp4 - timestamp3))"
